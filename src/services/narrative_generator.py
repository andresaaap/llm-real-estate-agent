...
class NarrativeGenerator:
    ...
    def generate_listings(self):
        ...
        prompt = """
        Objective:
        Generate 10 real estate listings based on the following example and in a format of symbol separated values, with the symbol being ###, with the following columns: Neighborhood, Price, Bedrooms, Bathrooms, House Size, Description.
